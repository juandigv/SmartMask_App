...
public class BluetoothMessageService extends Service {
    ...
    public MutableLiveData<Integer> getTVOC(){ return tvocLiveData; }
    ...
    public MutableLiveData<Boolean> getServiceWorking(){ return serviceWorkingLiveData; }
    public MutableLiveData<String> getBtName(){ return btNameLiveData; }
    public MutableLiveData<String> getBtAddress(){ return btAddressLiveData; }
}
